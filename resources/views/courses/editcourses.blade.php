...
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <form id="updateCourses" method="post" action="{{route('updateCourses')}}" enctype="multipart/form-data">
                                        @csrf
                                      
                                        <input type="hidden" value="{{$editCourses->id}}" name="id">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="courses_name"
                                                        ...
                                                        value="{{ $editCourses->courses_name }}" >
                                                    <span class="text-danger errrors"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="credithours"
                                                        ...
                                                        value="{{ $editCourses->credit_hours }}">> >
                                                    <span class="text-danger errrors"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
    ...
    <script>
        $(function() {
            $("#updateCourses").on('submit', function(event) {
                event.preventDefault()
                var formData = new FormData(this);
                $(".errors").empty()
                $.ajax({
                    type: "POST",
                    url: "{{route('updateCourses') }}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response) {
                        if (response.status) {
                            ...
                            location.href = "{{route('viewCourses')}}";
